...
export const serviceConfig = {
  ...
  CHAT_SERVER: {
    ...
    ENDPOINTS: {
      ...
      FETCH_PRIVATE_GROUPS: process.env.REACT_APP_CHAT_SERVER_FETCH_PRIVATE_GROUPS,
      FETCH_GROUP_MESSAGES: process.env.REACT_APP_CHAT_SERVER_FETCH_GROUP_MESSAGES,
    },
  }
};
